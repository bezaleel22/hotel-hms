...
(811, 'booking_confirm_message', 'We will send your booking confirmation to this email address.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(979, 'awsome_choice', 'Awesome choice! You are getting a great deal with your rate.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(987, 'write_request', 'Please write requests in English or the propertys language', NULL, NULL, NULL, NULL, NULL, NULL),
...
(1846, 'is_use_website', 'Is Use website', NULL, NULL, NULL, NULL, NULL, NULL),
(1847, 'visible_home', 'Is Home Page', NULL, NULL, NULL, NULL, NULL, NULL),
(1848, 'factory_rest', 'Factory rest', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `setting` (`id`, `title`, `storename`, `address`, `email`, `phone`, `logo`, `splash_logo`, `favicon`, `vat`, `isvatnumshow`, `vattinno`, `servicecharge`, `discount_type`, `service_chargeType`, `discountrate`, `country`, `map_key`, `latitude`, `longitude`, `currency`, `language`, `timezone`, `checkintime`, `checkouttime`, `dateformat`, `site_align`, `pricetxt`, `powerbytxt`, `footer_text`, `top_offer_visible_status`, `use_web_status`, `blog_offer_visible_status`, `home_about_visible_status`) VALUES
(2, 'Xain Hotel', 'Resort & Spa', 'United States, America', 'atrgworld@gmail.com', '00923244796787', '', '', '', 2, 1, NULL, 7, 1, 1, 0.000, '', 'AIzaSyB-EEPxbay_aFpp3jcFXpjyPQcVQUJ2pp0', 23.8311, 90.4243, 2, 'english', 'Asia/Dhaka', '12:00:00', '10:00:00', '', 'LTR', 'The crossed-out prices you see are based on prices currently being quoted by the property for a 30-day window around your check-in date. To ', 'Powered By: BDTASK ', '2021Â©Copyright', 1, 1, 0, 1);
...
(38, 'Terms for website', 'Conditions', 'Please use. for new line in invoice. terms and condition.');
...
(1, NULL, NULL, NULL, 'admin@gmail.com', NULL, 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, '2024-11-16 15:13:03', NULL, '::1', 1, 1, 1);
...
--
ALTER TABLE `room_image`
  MODIFY `room_img_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sec_role_permission`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2789;
...
--
ALTER TABLE `sec_user_access_tbl`
  MODIFY `role_acc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `tbl_financialyear`
  MODIFY `fiyear_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_openingbalance`
  MODIFY `opbalance_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_roomnofloorassign`
  MODIFY `roomassignid` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_slider`
  MODIFY `slid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `tbl_widget`
  MODIFY `widgetid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
