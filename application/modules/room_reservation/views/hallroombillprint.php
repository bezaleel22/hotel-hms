                ...
                <?php for ($i = 0; $i < count($ritems); $i++) { ?>
                    ...
                    <?php foreach ($ritems[$i] as $row) { ?>
                        <tr>
                            ...
                            <td class="invp-14"> <?php $subtotal += $row->rent;
                                                    echo html_escape($row->rent); ?>
                            </td>
                            <td class="invp-14">
                                <?php $total += $row->totalamount;
                                echo html_escape($row->totalamount); ?></td>
                        </tr>
                        <?php $sl++; ?>
                    <?php } ?>
                <?php } ?>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center" class="invp-24">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="invp-25">
                        <span><?php $scharge = ($hotel_details->servicecharge * $subtotal) / 100;
