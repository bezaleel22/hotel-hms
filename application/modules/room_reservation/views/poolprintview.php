                ...
                <div>
                    <address class="invp-12">
                        ...
                        <?php if ($poolcastinfo->cust_phone) { ?><span
                                class="invp-10"><?php echo display("mobile") ?>:&nbsp;</span><?php if ($poolcastinfo->cust_phone) {
                                                                                                    echo html_escape($poolcastinfo->cust_phone);
                                                                                                } ?>
                            <br><?php } ?>
                        <?php if ($poolcastinfo->email) { ?><span
                                class="invp-10"><?php echo display("email") ?>:&nbsp;</span><?php if ($poolcastinfo->email) {
                                                                                                echo html_escape($poolcastinfo->email);
                                                                                            } ?><?php } ?>
                    </address>
                </div>
            </div>
