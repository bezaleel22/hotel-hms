                ...
                <div>
                    <address class="invp-12">
                        ...
                        <?php if ($rcustomer->cust_phone) { ?><span
                                class="invp-10"><?php echo display("mobile") ?>:&nbsp;</span><?php if ($rcustomer->cust_phone) {
                                                                                                    echo html_escape($rcustomer->cust_phone);
                                                                                                } ?>
                            <br><?php } ?>
                        <?php if ($rcustomer->email) { ?><span
                                class="invp-10"><?php echo display("email") ?>:&nbsp;</span><?php if ($rcustomer->email) {
                                                                                                echo html_escape($rcustomer->email);
                                                                                            } ?><?php } ?>
                    </address>
                </div>
            </div>
                ...
                <?php for ($i = 0; $i < count($ritems); $i++) { ?>
                    ...
                    <?php foreach ($ritems[$i] as $row) { ?>
                        <tr>
                            ...
                            <td class="invp-14"> <?php $subtotal += $parking->price;
                                                    $tax += ($parking->vat * $parking->price) / 100;
                                                    echo html_escape($parking->price); ?>
                            </td>
                            <td class="invp-14">
                                <?php $total += $row->total_price;
                                echo html_escape($row->total_price); ?></td>
                        </tr>
                        <?php $sl++; ?>
                    <?php } ?>
                <?php } ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="invp-25">
                        <span><?php if ($currency->position == 1) {
                                    echo html_escape($currency->curr_icon);
                                } ?><?php echo $tax; ?><?php if ($currency->position == 2) {
                                                                                                                                    echo html_escape($currency->curr_icon);
                                                                                                                                } ?>
                        </span>
                    </td>
