        ...
        <tbody>
            ...
            <tr>
                ...
                <td style=" vertical-align:top; text-align: right; color: #37a000;">
                    ...
                    <script>
                        console.log({
                            paid_amount: <?php echo $bookinfo->paid_amount ?>
                            total_price: <?php echo $bookinfo->total_price ?>
                        });
                    </script>
    ...
    <table
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border: 1px solid #e4e5e7; padding: 8px 10px; vertical-align: top;">
                    <?php if ($bookinfo->bookingstatus == 0) {
                        echo display('pending');
                    }
                    if ($bookinfo->bookingstatus == 2) {
                        echo display('complete');
                    }
                    if ($bookinfo->bookingstatus == 1) {
                        echo display("cancel");
                    }
                    if ($bookinfo->bookingstatus == 4) {
        ...
        <div style="max-width: 100%; padding-right: 10px; padding-left: 10px; text-align: right!important;">
            <ul style="padding-left: 0; list-style: none; margin-top: 0; margin-bottom: 1rem;">
                        ...
                        foreach ($taxinfo as $tax) { ?>
                            <li>
                                <strong><?php echo html_escape($tax->taxname); ?>
                                    <?php echo html_escape($tax->rate); ?>%:</strong> <?php $singletax = 0;
                                                                                        $singletax = $tax->rate * $grprice / 100;
                                                                                        echo $singletax;
                                                                                        $totaltax += $singletax; ?>
                            </li>
                    <?php }
                ...
                <?php } else { ?>
                    ...
                    <?php if (!empty($taskname[0])) {
                        for ($bt = 0; $bt < count($taskname); $bt++) { ?>
                            <li>
                                <strong><?php echo html_escape($taskname[$bt]); ?>
                                    <?php echo html_escape($rate[$bt]); ?>%:</strong> <?php $singletax = 0;
                ...
                <li>
                    ...
                    } ?><?php echo $grand_total = number_format($totaltax + $postedbill + $grprice, 2); ?><?php if ($currency->position == 2) {
                                                                                                                echo html_escape($currency->curr_icon);
                                                                                                            } ?>
                    ...
                    <?php if ($currency->position == 1) {
                        echo html_escape($currency->curr_icon);
                            ...
                            $total_paid = $bookinfo->paid_amount + $promocode + $postedbill - $reducetax + ($bookinfo->bookingstatus == 5 ? $scharge : 0);
                            if ($bookinfo->bookingstatus == 5) {
                                echo $grand_total;
                            } else {
                    ...
                    <?php if ($currency->position == 1) {
                        echo html_escape($currency->curr_icon);
                            ...
                            $remain_amount = ($grprice + $postedbill + $reducetax) - ($bookinfo->paid_amount + $promocode + $postedbill + ($bookinfo->bookingstatus == 5 ? $scharge : 0));
                            if ($remain_amount < 0) {
                                echo "0";
                            } else {
                                echo $remain_amount;
                            }
                        } else echo html_escape($grprice + $scharge + $postedbill); ?><?php if ($currency->position == 2) {
                                                                                            echo html_escape($currency->curr_icon);
                                                                                        } ?>
                </li>
            </ul>
