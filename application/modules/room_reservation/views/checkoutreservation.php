            ...
            <select multiple="multiple" class="testselect2 SumoUnder" tabindex="-1" id="chroomno">
                <?php foreach ($checkinrooms as $rooms) { ?>
                    <option value="<?php echo html_escape($rooms->bookedid); ?>"
                        <?php if ($bookingdata[0]->bookedid == $rooms->bookedid) {
                            echo "Selected";
                        } ?>>
                    ...
                    ?>
                        <div class="customer-radio custom-control custom-radio pl-0 rounded bg-white border mb-2">
                            <input type="radio" id="custom_radio_<?php echo $j; ?>"
                                ...
                                name="customer-radio" class="custom-control-input" <?php if ($j == 0) {
                                                                                        echo "checked";
                                                                                    } ?>
                ...
                <table class="table table-bordered table-sm mb-0">
                    ...
                    <tbody>
                        ...
                        ?>
                                    ...
                                    <table class="table table-bordered table-sm mb-0 tr-background">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php if ($currency->position == 1) {
                                                        echo "(" . html_escape($currency->curr_icon) . ") ";
                                                    } ?><?php echo display("rent_day") ?>
                                                ...
                                                <th><?php if ($currency->position == 1) {
                                                        echo "(" . html_escape($currency->curr_icon) . ") ";
                                                    } ?><?php echo display("rent") . " " . display("discount"); ?>
                                                    <?php if ($currency->position == 2) {
                                                        echo "(" . html_escape($currency->curr_icon) . ")";
                                                    } ?>
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($poolbill)) {
                                                for ($pc = 0; $pc < count($poolbill[$l]); $pc++) {
                                                    if ($poolbill[$l][$pc]->status == 1) {
                                                        $poolbillpaidamt += $poolbill[$l][$pc]->total_amount;
                                                    } else {
                                                        $poolbillamt += $poolbill[$l][$pc]->total_amount;
                                                        $singlepid .= $poolbill[$l][$pc]->pbookingid . ",";
                                                    }
                                                }
                                            }
                            ...
                            <?php $orderid .= $singleorder . ",";
                            $poolid .= $singlepid . ",";
                            $hallid .= $singlehall . ",";
                            $parkingid .= $singleparking . ","; ?>
                        <?php } ?>
                    </tbody>
                </table>
            </div>
                    ...
                    <table class="table table-sm table-borderless mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                                echo html_escape($currency->curr_icon);
                                            } ?><span
                                            id="allroomrent"><?php echo html_escape($allroomrent); ?></span><?php if ($currency->position == 2) {
                                                                                                                echo html_escape($currency->curr_icon);
                                                                                                            } ?></strong>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="disamount">0</span><?php if ($currency->position == 2) {
                                                                        echo html_escape($currency->curr_icon);
                                                                    } ?></strong>
                                </td>
                            </tr>
                            <?php if ($promocode > 0) { ?>
                                <tr>
                                    ...
                                    <td><strong><?php if ($currency->position == 1) {
                                                ...
                                                id="disamount"><?php echo html_escape($promocode); ?></span><?php if ($currency->position == 2) {
                                                                                                                echo html_escape($currency->curr_icon);
                                                                                                            } ?></strong>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="scharge"><?php echo $scharge = ($allroomrent * $setting->servicecharge) / 100; ?></span><?php if ($currency->position == 2) {
                                                                                                                                            echo html_escape($currency->curr_icon);
                                                                                                                                        } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="totalroomrentamount"><?php echo $allroomrent += $scharge; ?></span><?php if ($currency->position == 2) {
                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                    } ?></strong>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="allcomplementarycharge"><?php echo $allcomplementarycharge *= $days; ?></span><?php if ($currency->position == 2) {
                                                                                                                                    echo html_escape($currency->curr_icon);
                                                                                                                                } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="allbpccharge"><?php echo html_escape($allbpccharge); ?></span><?php if ($currency->position == 2) {
                                                                                                                    echo html_escape($currency->curr_icon);
                                                                                                                } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="alladvanceamount"><?php echo html_escape($alladvanceamount); ?></span><?php if ($currency->position == 2) {
                                                                                                                            echo html_escape($currency->curr_icon);
                                                                                                                        } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong>
                                        <?php if ($currency->position == 1) {
                                            ...
                                            id="payableamount"><?php echo $payableamount = $allroomrentandtax + $allcomplementarycharge + $allbpccharge - $alladvanceamount - $promocode; ?></span><?php if ($currency->position == 2) {
                                                                                                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                                                                                                    } ?></strong>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><strong>
                                        <?php if ($currency->position == 1) {
                                            ...
                                            id="netpayableamount"><?php echo html_escape($payableamount); ?></span><?php if ($currency->position == 2) {
                                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                                    } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="creditamt">0.00</span><?php if ($currency->position == 2) {
                                                                            echo html_escape($currency->curr_icon);
                                                                        } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="complemetaryamt">0.00</span><?php if ($currency->position == 2) {
                                                                                echo html_escape($currency->curr_icon);
                                                                            } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="payableamt"><?php echo $payableamount + $poolbillamt + $restbill + $hallbill + $parkingbill; ?></span><?php if ($currency->position == 2) {
                                                                                                                                                            echo html_escape($currency->curr_icon);
                                                                                                                                                        } ?></strong>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="pl-0">
                                    ...
                                    <?php echo display("credit_amt") ?>.<?php if ($currency->position == 2) {
                                                                            echo "(" . html_escape($currency->curr_icon) . ")";
                                                                        } ?>
                                </th>
                                <td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="pl-0">
                                    <?php if ($currency->position == 1) {
                                        echo "(" . html_escape($currency->curr_icon) . ")";
                                    } ?><?php echo display("discount_amt") ?>.<?php if ($currency->position == 2) {
                                                                                    echo "(" . html_escape($currency->curr_icon) . ")";
                                                                                } ?>
                                </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="balance">0.00</span><?php if ($currency->position == 2) {
                                                                        echo html_escape($currency->curr_icon);
                                                                    } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="collectedamt">0.00</span><?php if ($currency->position == 2) {
                                                                                echo html_escape($currency->curr_icon);
                                                                            } ?></strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><strong><?php if ($currency->position == 1) {
                                            ...
                                            id="refunddamt">0.00</span><?php if ($currency->position == 2) {
                                                                            echo html_escape($currency->curr_icon);
                                                                        } ?></strong>
                                </td>
                            </tr>
                                    ...
                                    <table class="invp-17">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php foreach ($taxsetting as $tax) { ?>
                                                    <td class="invp-20">
                                                        <?php echo $invat = ($tax->rate * $intotal) / 100;
                                                        $singlevat += $invat; ?>
                                                    </td>
                                                <?php } ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="invp-26" width="80">
                                <?php if ($currency->position == 1) {
                                    echo html_escape($currency->curr_icon);
                                } ?><?php echo $allroomrentandtax - $allinvat; ?><?php if ($currency->position == 2) {
                                                                                        echo html_escape($currency->curr_icon);
                                                                                    } ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class=" invp-27">
                                <small><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><?php echo html_escape($allinvat); ?><?php if ($currency->position == 2) {
                                                                                        echo html_escape($currency->curr_icon);
                                                                                    } ?></small>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class=" invp-27">
                                <small><?php if ($currency->position == 1) {
                                            echo html_escape($currency->curr_icon);
                                        } ?><?php echo html_escape($scharge); ?><?php if ($currency->position == 2) {
                                                                                    echo html_escape($currency->curr_icon);
                                                                                } ?></small>
                            </td>
                        </tr>
                        <?php if ($allcomplementarycharge > 0) { ?>
                            <tr>
                                ...
                                <td class=" invp-27">
                                    <small><?php if ($currency->position == 1) {
                                                echo html_escape($currency->curr_icon);
                                            } ?><?php echo html_escape($allcomplementarycharge); ?><?php if ($currency->position == 2) {
                                                                                                        echo html_escape($currency->curr_icon);
                                                                                                    } ?></small>
                                </td>
                            </tr>
                        ...
                        <?php if ($allbpccharge > 0) { ?>
                            <tr>
                                ...
                                <td class=" invp-27">
                                    <small><?php if ($currency->position == 1) {
                                                echo html_escape($currency->curr_icon);
                                            } ?><?php echo html_escape($allbpccharge); ?><?php if ($currency->position == 2) {
                                                                                                echo html_escape($currency->curr_icon);
                                                                                            } ?></small>
                                </td>
                            </tr>
                        ...
                        <?php if ($alladvanceamount > 0) { ?>
                            <tr>
                                ...
                                <td class=" invp-27">
                                    <small><?php if ($currency->position == 1) {
                                                echo html_escape($currency->curr_icon);
                                            } ?><?php echo html_escape($alladvanceamount); ?><?php if ($currency->position == 2) {
                                                                                                    echo html_escape($currency->curr_icon);
                                                                                                } ?></small>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td class="invp-28">
                                <strong
                                    id="inpayableamt"><?php if ($currency->position == 1) {
                                                            echo html_escape($currency->curr_icon);
                                                        } ?><?php echo $payableamount + $poolbillamt + $restbill + $hallbill + $parkingbill; ?><?php if ($currency->position == 2) {
                                                                                                                                                    echo html_escape($currency->curr_icon);
                                                                                                                                                } ?></strong>
                            </td>
                        </tr>
