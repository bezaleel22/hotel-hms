                    ...
                    <?php foreach ($roomlist as $list) { ?>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 col-xxl-2 mb-3">
                            <div class="position-relative d-flex justify-content-center">
                                ...
                                <div
                                    class="scroll-bar overlay-<?php if ($list->status == 2 | $list->status == 4) {
                                                                    echo "green";
                                                                    ...
                                                                    echo "orange"; // Assigned to clean
                                                                } elseif ($list->status == 6) {
                                                                    echo "brown";  // Dirty
                                                                } elseif ($list->status == 9) {
                                                                    echo "yellow"; // Under Process
                                                                } else {
                                                                    echo "black";
                                    ...
                                    <button type="button"
                                        class="btn btn-<?php if ($list->status == 2 | $list->status == 4) {
                                                            echo "primary";
                                                        } elseif ($list->status == 1) {
                                                            echo "success";
                                                        } elseif ($list->status == 0) {
                                                            ...
                                                            echo "info";      // Assigned to clean - blue
                                                        } elseif ($list->status == 6) {
                                                            echo "secondary"; // Dirty - gray
                                                        } elseif ($list->status == 9) {
                                                            echo "danger";    // Under Process - red
                                                        } else {
                                                            echo "dark";      // Default
