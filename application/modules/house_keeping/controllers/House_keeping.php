...
class House_keeping extends MX_Controller
{
	...
	public function roomcleaninglist()
	{
		...
		$sql = "SELECT tbl_housekeepingrecord.*,eh.first_name COLLATE utf8mb3_general_ci as first_name 
        FROM tbl_housekeepingrecord 
        LEFT JOIN employee_history eh ON eh.employee_id COLLATE utf8mb3_general_ci = tbl_housekeepingrecord.employee_id COLLATE utf8mb3_general_ci";
		$sqlTot .= $sql;
		$sqlRec .= $sql;
