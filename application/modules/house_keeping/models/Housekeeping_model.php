...
class Housekeeping_model extends CI_Model
{
	...
	{
		$sql = "SELECT hr.*, eh.first_name COLLATE utf8mb3_general_ci as first_name
            FROM {$this->table} hr
            LEFT JOIN employee_history eh ON eh.employee_id COLLATE utf8mb3_general_ci = hr.employee_id COLLATE utf8mb3_general_ci
            WHERE hr.hkeeper_id = ? 
            AND hr.status != 1
            ORDER BY hr.hkeeper_id DESC";
