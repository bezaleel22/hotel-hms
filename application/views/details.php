                        ...
                        <div class="col-md-5 col-lg-4">
                            <div class="card card-body rounded-0 mb-3 p-4">
                                ...
                                <div class="price_details">
                                    <ul class="list-unstyled">
                                        <li class="list_item">
                                            ...
                                            <span
                                                class="list_item_price"><?php if ($this->storecurrency->position == 1) {
                                                                            echo $this->storecurrency->curr_icon;
                                                                        } ?><?php echo html_escape($total); ?><?php if ($this->storecurrency->position == 2) {
                                                                                                                                                                                                    echo $this->storecurrency->curr_icon;
                                                                                                                                                                                                } ?></span>
                                        </li>
                                        <li class="list_item">
                                        ...
                                        <li class="list_item">
                                            ...
                                            <span
                                                class="list_item_price"><?php if ($this->storecurrency->position == 1) {
                                                                            echo $this->storecurrency->curr_icon;
                                                                        } ?><?php echo html_escape($taxamount = (($total - $totaldiscount) * $tax) / 100); ?><?php if ($this->storecurrency->position == 2) {
                                                                                                                                                                                                                                        echo $this->storecurrency->curr_icon;
                                                                                                                                                                                                                                    } ?></span>
                                        </li>
                                        <li class="list_item">
                                            ...
                                            <span
                                                class="list_item_price"><?php if ($this->storecurrency->position == 1) {
                                                                            echo $this->storecurrency->curr_icon;
                                                                        } ?><?php echo html_escape($serviceamnt = (($total - $totaldiscount) * $servicecharge) / 100); ?><?php if ($this->storecurrency->position == 2) {
                                                                                                                                                                                                                                                    echo $this->storecurrency->curr_icon;
                                                                                                                                                                                                                                                } ?></span>
                                        </li>
                                    </ul>
                                ...
                                <div class="form-group row justify-content-around">
                                    ...
                                    <input type="hidden"
                                        value="<?php if ($totaldiscount > 0) { ?><?php $dis = $totaldiscount;
                                                                            echo $dis; ?><?php } ?>"
                                        id="total_discount">
                                    <input type="hidden"
                                    ...
                                    <div class="list_item mb-3">
                                        ...
                                        <div class="list_item_price">
                                            <span class="rack-price text-danger">
                                                <?php if ($totaldiscount > 0) { ?><s><?php if ($this->storecurrency->position == 1) {
                                                                                    echo $this->storecurrency->curr_icon;
                                                                                } ?><?php $dis = $totaldiscount;
                                                                                                                                                                    echo $dis; ?><?php if ($this->storecurrency->position == 2) {
                                                                                                                                                                                                                    echo $this->storecurrency->curr_icon;
                                                                                                                                                                                                                } ?></s><?php } ?>
                                            </span>
                                            <span class="discount-price text-success fs-21 font-weight-600" data-toggle="popover"
                                                ...
                                                <?php if ($this->storecurrency->position == 1) {
                                                    echo $this->storecurrency->curr_icon;
                                                } ?><?php echo html_escape((!empty($dis) ? ($total + $taxamount + $serviceamnt) - $dis : ($total + $taxamount + $serviceamnt))); ?><?php if ($this->storecurrency->position == 2) {
                                                                                                                                                                                                                                                            echo $this->storecurrency->curr_icon;
                                                                                                                                                                                                                                                        } ?>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="f_name" name="f_name"
                                        value="<?php if ($this->session->userdata('UserID') == TRUE) {
                                                    echo html_escape($userinfo->firstname);
                                                } ?>"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="l_name" name="l_name"
                                        value="<?php if ($this->session->userdata('UserID') == TRUE) {
                                                    echo html_escape($userinfo->lastname);
                                                } ?>"
                                        autocomplete="off" required>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="<?php if ($this->session->userdata('UserID') == TRUE) {
                                                    echo html_escape($userinfo->email);
                                                } ?>"
                                        autocomplete="off" required>
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" class="form-control" id="phone" name="phone"
                                        value="<?php if ($this->session->userdata('UserID') == TRUE) {
                                                    echo html_escape($userinfo->cust_phone);
                                                } ?>"
                                        autocomplete="off" required>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <textarea type="text" palaceholder="Address" class="form-control" id="address" name="address"
                                        value="<?php if ($this->session->userdata('UserID') == TRUE) {
                                                    echo html_escape($userinfo->address);
                                                } ?>"
